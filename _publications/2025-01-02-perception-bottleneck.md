...
This paper investigates the perception bottleneck of Vision-Language Models (VLMs) for chart understanding tasks, revealing that visual perception limitations significantly impact VLM performance on chart-related benchmarks.
